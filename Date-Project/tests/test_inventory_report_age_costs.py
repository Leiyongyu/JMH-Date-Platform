...
def test_department_summary_uses_next_month_clearance_age_costs(monkeypatch):
    ...
    assert rows["EBAY-1"]["inventory_age_90_180_cost"] is None
    assert rows["AUTO-PARTS-TOTAL"]["inventory_age_90_180_cost"] == "150"
    assert rows["AUTO-PARTS-TOTAL"]["inventory_age_180_plus_cost"] == "15"
