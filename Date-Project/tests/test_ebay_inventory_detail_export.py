...
def test_export_contains_all_27_columns_numeric_cells_and_safe_text(monkeypatch):
    data = {"items": [{
    ...
    try:
        ...
        assert sheet.max_column == len(export_service.COLUMNS) == 27
        ...
        assert sheet.auto_filter.ref == "A1:AA2"
