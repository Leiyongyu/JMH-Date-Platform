...
export function pricePresentation(platform) {
  return platform === 'ebay'
    // eBay 价格来自在售刊登的挂牌价，原币是 EUR/GBP/USD，要按 rate_org 换成美元。
    ? { currency: 'USD', label: '美元', rateField: 'rate_org', usesFx: true,
        ...
        formula: '美元价 = 原币挂牌价 × rate_org(原币) ÷ rate_org(USD)；原币就是美元时不经过汇率' }
