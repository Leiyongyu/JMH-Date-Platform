...
const strategyPresetMap = {
  BALANCED: {
    ...
    deductFbaStock: 1, deductFbaInbound: 1, deductFbaInboundWorking: 0, deductDomesticStock: 1, deductPurchasedQty: 1, deductPendingShipQty: 1,
